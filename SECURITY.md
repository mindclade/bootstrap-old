...
| Channel | For |
|---|---|
| [Private security advisory](https://github.com/mindclade-org/bootstrap/security/advisories/new) | Anything in this repository. Preferred |
...
[`mindclade-org/.github/SECURITY.md`](https://github.com/mindclade-org/.github/blob/main/SECURITY.md).
