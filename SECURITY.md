...
# Mindclade security policy · `bootstrap`
...
| Repository scope | Ring-0 state, identity, seed projects, and recovery |

**Do not open a public issue for a vulnerability.**

| Channel | For |
|---|---|
| [Private security advisory](https://github.com/mindclade/bootstrap/security/advisories/new) | Anything in this repository. Preferred |
...
This repository holds the break-glass identity, every WIF binding, and the state backends. It is the most privileged configuration in the estate. Read access to it is read access to how everything is secured — report anything that widens it, however small.
