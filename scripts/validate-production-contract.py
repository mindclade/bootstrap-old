...
CONTRACT=json.loads('{"authority": ["ring0-state", "automation-federation", "seed-projects", "break-glass-recovery"], "forbidden_authority": ["normal-folders", "normal-org-policy", "workload-projects", "networks", "gke", "kubernetes-desired-state"], "forbidden_paths": ["modules/folders", "modules/governance", ".terraform", ".terragrunt-cache"], "repository_class": "enterprise-control", "required_paths": ["modules/state", "modules/identity", "modules/projects", "modules/naming", "docs/first-apply.md", "docs/break-glass.md", "docs/state-recovery.md"], "visibility": "private"}')
ERRORS=[]
