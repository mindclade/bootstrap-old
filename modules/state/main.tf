...
# `.tflock` object, including for read-only plans. The unconditional objectViewer grant above
# supplies reads and object listing; this conditioned role supplies only lock-object writes.
